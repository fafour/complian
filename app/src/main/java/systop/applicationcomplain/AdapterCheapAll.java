 ...
 */
public class AdapterCheapAll extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterCheapAll(Context context, List<DataComplain> data){
    ...
    class MyHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void onClick(View v) {
            ...
            Intent intent3 = new Intent(context, MenuCheapResultActivity.class);
