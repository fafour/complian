...
/**
 * Created by Fafour on 22/10/2559.
 */
public class AdapterEmployee extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterEmployee(Context context, List<DataComplain> data){
    ...
    class MyHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void onClick(View v) {
            ...
            final CharSequence[] items = { "ดูรายละเอียด","แก้ไขข้อมูล","แก้ไขสถานะ","ลบข้อมูล"};
