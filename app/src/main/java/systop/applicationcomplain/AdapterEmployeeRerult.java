 ...
 */
public class AdapterEmployeeRerult extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterEmployeeRerult(Context context, List<DataComplain> data){
    ...
    class MyHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void onClick(View v) {
            ...
            final CharSequence[] items = { "ดูรายละเอียด","แก้ข้อมูล","แก้ไขสถานะ","ลบข้อมูล"};
            adb.setItems(items, new AlertDialog.OnClickListener() {
                public void onClick(DialogInterface dialog, int which) {
                    switch (which) {
                        case 0:
                            current=data.get(position1);
                            Intent intent31 = new Intent(context, ScrollingData1Activity.class);
                        ...
                        case 3:
                            ...
                            notifyItemRangeRemoved(position1,data.size());
