 ...
 */
public class AdapterEmployeeRerult1 extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterEmployeeRerult1(Context context, List<DataComplain> data){
    ...
    class MyHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void onClick(View v) {
            ...
            final CharSequence[] items = { "ดูรายละเอียด","แก้ข้อมูล","แก้ไขสถานะ","แก้ไข้ผู้รับผิดชอบ","ลบข้อมูล"};
