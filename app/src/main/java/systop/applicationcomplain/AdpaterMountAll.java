 ...
 */
public class AdpaterMountAll extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdpaterMountAll(Context context, List<DataComplain> data){
    ...
    class MyHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void onClick(View v) {
            ...
            Intent intent3 = new Intent(context, MenuMountResultActivity.class);
