...
public class Manage1Activity extends AppCompatActivity {
    public static final int CONNECTION_TIMEOUT = 10000;
    public static final int READ_TIMEOUT = 15000;
    private RecyclerView mRVManageEmployee;
    private AdapterManageResult mAdapter;
    ...
    private class AsyncFetch extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            try {
                ...
                url = new URL(localhost.url+"resultEmployee.php");
        ...
        protected void onPostExecute(String result) {
            ...
            mAdapter = new AdapterManageResult(Manage1Activity.this, data);
            mRVManageEmployee.setAdapter(mAdapter);
            mRVManageEmployee.setLayoutManager(new LinearLayoutManager(Manage1Activity.this));
