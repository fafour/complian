...
public class MenuCheapActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_menu_cheap);
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                final AlertDialog.Builder dialog1 = new AlertDialog.Builder(MenuCheapActivity.this);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.action_search:
                Intent intent = new Intent(getApplicationContext(), SearchCheapActivity.class);
                startActivity(intent);
                break;
            default:
                break;
    ...
    private class AsyncFetch extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            try {
                ...
                url = new URL(localhost.url+"cheap1.php");
        ...
        protected void onPostExecute(String result) {
            ...
            mAdapter = new AdapterCheap(MenuCheapActivity.this, data);
            mRVManageEmployee.setAdapter(mAdapter);
            mRVManageEmployee.setLayoutManager(new LinearLayoutManager(MenuCheapActivity.this));
