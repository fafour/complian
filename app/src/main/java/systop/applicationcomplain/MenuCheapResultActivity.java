...
public class MenuCheapResultActivity extends AppCompatActivity {
    public static final int CONNECTION_TIMEOUT = 10000;
    public static final int READ_TIMEOUT = 15000;
    private RecyclerView mRVManageEmployee;
    private AdapterCheapResuit mAdapter;
...
//    private final Handler handler = new Handler();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_menu_cheap_result);
    ...
    private class AsyncFetch extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            try {
                ...
                url = new URL(localhost.url+"cheapResult.php");
        ...
        protected void onPostExecute(String result) {
            ...
            mAdapter = new AdapterCheapResuit(MenuCheapResultActivity.this, data);
            mRVManageEmployee.setAdapter(mAdapter);
            mRVManageEmployee.setLayoutManager(new LinearLayoutManager(MenuCheapResultActivity.this));
