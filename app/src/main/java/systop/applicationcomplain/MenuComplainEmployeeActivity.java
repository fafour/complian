...
public class MenuComplainEmployeeActivity extends AppCompatActivity {
...
//    private final Handler handler = new Handler();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_menu_complain_employee);
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                final AlertDialog.Builder dialog1 = new AlertDialog.Builder(MenuComplainEmployeeActivity.this);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.action_search:
                String User = getIntent().getStringExtra("User");
                Intent intent = new Intent(getApplicationContext(), SearchComplainEmpActivity.class);
                intent.putExtra("User", User);
                startActivity(intent);
                break;
            default:
...
//                handler.removeMessages(0);
    ...
    private class AsyncFetch extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            mAdapter = new AdapterEmployee(MenuComplainEmployeeActivity.this, data);
            mRVManageEmployee.setAdapter(mAdapter);
            mRVManageEmployee.setLayoutManager(new LinearLayoutManager(MenuComplainEmployeeActivity.this));
