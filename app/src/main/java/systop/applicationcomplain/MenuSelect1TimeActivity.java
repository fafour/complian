...
public class MenuSelect1TimeActivity extends AppCompatActivity {
...
//    private final Handler handler = new Handler();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_menu_select1_time);
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                final AlertDialog.Builder dialog1 = new AlertDialog.Builder(MenuSelect1TimeActivity.this);
...
//                handler.removeMessages(0);
    ...
    private class AsyncFetch extends AsyncTask<String, String, String> {
        ...
        URL url = null;
        String mount = getIntent().getStringExtra("time1");
        String year = getIntent().getStringExtra("time2");
        ...
        protected String doInBackground(String... params) {
            try {
                ...
                url = new URL(localhost.url+"select_between.php");
            ...
            try {
                ...
                Uri.Builder builder = new Uri.Builder().appendQueryParameter("searchQuery", mount)
                        .appendQueryParameter("searchQuery1", year);
        ...
        protected void onPostExecute(String result) {
            ...
            if (result.equals("no rows")){
                final AlertDialog.Builder dialogs = new AlertDialog.Builder(MenuSelect1TimeActivity.this);
...
//                        handler.removeMessages(0);
                ...
                try {
                    ...
                    mAdapter = new AdpaterMount(MenuSelect1TimeActivity.this, data);
                    mRVManageEmployee.setAdapter(mAdapter);
                    mRVManageEmployee.setLayoutManager(new LinearLayoutManager(MenuSelect1TimeActivity.this));
