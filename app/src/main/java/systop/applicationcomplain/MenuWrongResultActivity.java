...
public class MenuWrongResultActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_menu_wrong_result);
    ...
    private class AsyncFetch extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            try {
                ...
                url = new URL(localhost.url+"wrongResult.php");
        ...
        protected void onPostExecute(String result) {
            ...
            mAdapter = new AdapterWrongResult(MenuWrongResultActivity.this, data);
            mRVManageEmployee.setAdapter(mAdapter);
            mRVManageEmployee.setLayoutManager(new LinearLayoutManager(MenuWrongResultActivity.this));
