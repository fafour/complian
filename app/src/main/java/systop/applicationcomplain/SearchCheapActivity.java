...
public class SearchCheapActivity extends AppCompatActivity {
    public static final int CONNECTION_TIMEOUT = 10000;
    public static final int READ_TIMEOUT = 15000;
    private RecyclerView searchList;
    private AdapterCheapAll mAdapter;

    SearchView searchView = null;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_search_cheap);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        SearchManager searchManager = (SearchManager) SearchCheapActivity.this.getSystemService(Context.SEARCH_SERVICE);
        if (searchItem != null) {
            searchView = (SearchView) searchItem.getActionView();
        }
        if (searchView != null) {
            searchView.setSearchableInfo(searchManager.getSearchableInfo(SearchCheapActivity.this.getComponentName()));
    ...
    private class AsyncFetch extends AsyncTask<String, String, String> {
        ...
        ProgressDialog pdLoading = new ProgressDialog(SearchCheapActivity.this);
        ...
        protected String doInBackground(String... params) {
            try {
                ...
                url = new URL(localhost.url+"searchCheap.php");
        ...
        protected void onPostExecute(String result) {
            ...
            if(result.equals("no rows")) {
                ...
                mAdapter = new AdapterCheapAll(SearchCheapActivity.this, data);
                searchList.setAdapter(mAdapter);
                searchList.setLayoutManager(new LinearLayoutManager(SearchCheapActivity.this));AlertDialog.Builder dialog = new AlertDialog.Builder(SearchCheapActivity.this);
                ...
                dialog.show();Toast.makeText(SearchCheapActivity.this, "ไม่พบข้อมูลที่ค้นหา", Toast.LENGTH_LONG).show();
            }else{
                ...
                try {
                    ...
                    mAdapter = new AdapterCheapAll(SearchCheapActivity.this, data);
                    searchList.setAdapter(mAdapter);
                    searchList.setLayoutManager(new LinearLayoutManager(SearchCheapActivity.this));

                } catch (JSONException e) {
                    // You to understand what actually error is and handle it appropriately
                    Toast.makeText(SearchCheapActivity.this, e.toString(), Toast.LENGTH_LONG).show();
                    Toast.makeText(SearchCheapActivity.this, result.toString(), Toast.LENGTH_LONG).show();
                }
