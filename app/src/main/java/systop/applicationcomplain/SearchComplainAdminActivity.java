...
public class SearchComplainAdminActivity extends AppCompatActivity {
    public static final int CONNECTION_TIMEOUT = 10000;
    public static final int READ_TIMEOUT = 15000;
    private RecyclerView searchList;
    private AdapterEmployeeAll1 mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_search_complain_admin);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        SearchManager searchManager = (SearchManager) SearchComplainAdminActivity.this.getSystemService(Context.SEARCH_SERVICE);
        if (searchItem != null) {
            searchView = (SearchView) searchItem.getActionView();
        }
        if (searchView != null) {
            searchView.setSearchableInfo(searchManager.getSearchableInfo(SearchComplainAdminActivity.this.getComponentName()));
    ...
    private class AsyncFetch extends AsyncTask<String, String, String> {
        ...
        ProgressDialog pdLoading = new ProgressDialog(SearchComplainAdminActivity.this);
        ...
        protected String doInBackground(String... params) {
            try {
                ...
                url = new URL(localhost.url+"searchAdmin.php");
        ...
        protected void onPostExecute(String result) {
            ...
            if(result.equals("no rows")) {
                ...
                mAdapter = new AdapterEmployeeAll1(SearchComplainAdminActivity.this, data);
                searchList.setAdapter(mAdapter);
                searchList.setLayoutManager(new LinearLayoutManager(SearchComplainAdminActivity.this));
                AlertDialog.Builder dialog = new AlertDialog.Builder(SearchComplainAdminActivity.this);
                ...
                try {
                    ...
                    Toast.makeText(SearchComplainAdminActivity.this, e.toString(), Toast.LENGTH_LONG).show();
                    Toast.makeText(SearchComplainAdminActivity.this, result.toString(), Toast.LENGTH_LONG).show();
                }
