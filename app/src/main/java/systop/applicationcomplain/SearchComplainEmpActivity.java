...
public class SearchComplainEmpActivity extends AppCompatActivity {
    ...
    private AdapterEmployeeAll mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_search_complain_emp);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        SearchManager searchManager = (SearchManager) SearchComplainEmpActivity.this.getSystemService(Context.SEARCH_SERVICE);
        if (searchItem != null) {
            searchView = (SearchView) searchItem.getActionView();
        }
        if (searchView != null) {
            searchView.setSearchableInfo(searchManager.getSearchableInfo(SearchComplainEmpActivity.this.getComponentName()));
    ...
    private class AsyncFetch extends AsyncTask<String, String, String> {
        ...
        ProgressDialog pdLoading = new ProgressDialog(SearchComplainEmpActivity.this);
        ...
        protected String doInBackground(String... params) {
            try {
                ...
                url = new URL(localhost.url+"searchReson.php");
            ...
            try {
                ...
                Uri.Builder builder = new Uri.Builder().appendQueryParameter("searchQuery", searchQuery)
                        .appendQueryParameter("responsiblePerson", User);
        ...
        protected void onPostExecute(String result) {
            ...
            if(result.equals("no rows")) {
                ...
                mAdapter = new AdapterEmployeeAll(SearchComplainEmpActivity.this, data);
                searchList.setAdapter(mAdapter);
                searchList.setLayoutManager(new LinearLayoutManager(SearchComplainEmpActivity.this));
                AlertDialog.Builder dialog = new AlertDialog.Builder(SearchComplainEmpActivity.this);
                ...
                try {
                    ...
                    Toast.makeText(SearchComplainEmpActivity.this, e.toString(), Toast.LENGTH_LONG).show();
                    Toast.makeText(SearchComplainEmpActivity.this, result.toString(), Toast.LENGTH_LONG).show();
                }
