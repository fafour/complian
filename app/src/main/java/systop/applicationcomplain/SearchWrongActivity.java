...
public class SearchWrongActivity extends AppCompatActivity {
    public static final int CONNECTION_TIMEOUT = 10000;
    public static final int READ_TIMEOUT = 15000;
    private RecyclerView searchList;
    private AdapterWrongAll mAdapter;

    SearchView searchView = null;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_search_wrong);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        SearchManager searchManager = (SearchManager) SearchWrongActivity.this.getSystemService(Context.SEARCH_SERVICE);
        if (searchItem != null) {
            searchView = (SearchView) searchItem.getActionView();
        }
        if (searchView != null) {
            searchView.setSearchableInfo(searchManager.getSearchableInfo(SearchWrongActivity.this.getComponentName()));
    ...
    private class AsyncFetch extends AsyncTask<String, String, String> {
        ...
        ProgressDialog pdLoading = new ProgressDialog(SearchWrongActivity.this);
        ...
        protected String doInBackground(String... params) {
            try {
                ...
                url = new URL(localhost.url+"searchWrong.php");
        ...
        protected void onPostExecute(String result) {
            ...
            if(result.equals("no rows")) {
                ...
                mAdapter = new AdapterWrongAll(SearchWrongActivity.this, data);
                searchList.setAdapter(mAdapter);
                searchList.setLayoutManager(new LinearLayoutManager(SearchWrongActivity.this));
                AlertDialog.Builder dialog = new AlertDialog.Builder(SearchWrongActivity.this);
                ...
                try {
                    ...
                    Toast.makeText(SearchWrongActivity.this, e.toString(), Toast.LENGTH_LONG).show();
                    Toast.makeText(SearchWrongActivity.this, result.toString(), Toast.LENGTH_LONG).show();
                }
