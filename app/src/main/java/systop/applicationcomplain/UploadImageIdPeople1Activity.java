...
//    }
    ...
    public void UploadImageToServer(){
        ...
        if (bitmap != null) {
            ...
            AlertDialog alertDialog = new AlertDialog.Builder(UploadImageIdPeople1Activity.this).create();
        ...
        class AsyncTaskUploadClass extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                ...
                progressDialog = ProgressDialog.show(UploadImageIdPeople1Activity.this,"กำลังอัพโหลดข้อมูล","กรุณารอสักครู่",false,false);
            }
            ...
            protected void onPostExecute(String string1) {
                ...
                if(!string1.isEmpty() && !string1.equals("")){
                    ...
                    Toast.makeText(UploadImageIdPeople1Activity.this,string1,Toast.LENGTH_LONG).show();
